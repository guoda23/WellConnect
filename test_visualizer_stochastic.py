...
for noise_level in [0.05, 0.30]:
        ...
        output_gen.plot_heatmaps(traits=['Gender_tertiary'], target_entropy=True,
                                ...
                                save_path=f"Results/homophily_f_retrievability/heatmap_noise_{noise_level}.png",
                                suptitle=False, custom_trait_labels=custom_trait_labels, dpi=150)
